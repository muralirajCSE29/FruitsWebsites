      ...
      <div className="md:flex justify-between w-5/6 md:max-w-7xl mx-auto">
        ...
        <div className={`flex md:block justify-end ${open ? "block" : "hidden"}`}>
          <ul className="md:flex md:space-x-8 space-y-8 md:space-y-0">
            <li className="text-slate-500 text-lg hover:bg-red-400 px-4 py-2 hover:rounded-full hover:text-white transform ease-out duration-150 border-b-4  border-green-500">
              <a href="#" className="font-body  ">
                Fruits
              </a>
            </li>
            <li className="text-slate-500 text-lg  hover:bg-red-400 px-4 py-2 hover:rounded-full hover:text-white">
              <a href="#" className="font-body">
                Vegetables
              </a>
            </li>
